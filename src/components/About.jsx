...
const About = () => {
  return (
    <div id='About'>
        <h1>About Me</h1>
      <p>Hello, my name is Rohith Jangam, and I love creating things that live on the internet and thrive on the endless possibilities of the digital world. I am fascinated by the power of code to bring ideas to life and to solve real-world problems.</p>
